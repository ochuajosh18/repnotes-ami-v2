...
const ActivityLogFilters = () => {
  ...
  const spOptions = filterSelectedCompany ? [allOption, ...salesPersonOptions] : salesPersonOptions;
  const custOptions = filterSelectedCompany ? [allOption, ...customerOptions] : customerOptions;
  const provOptions = filterSelectedCompany ? [allOption, ...provinceOptions] : provinceOptions;
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} sm={3}>
        <RepnotesInput
          ...
          autocompleteOptions={custOptions}
          onAutocompleteChange={(e, o) => {
      ...
      <Grid item xs={12} sm={3}>
        <RepnotesInput
          ...
          autocompleteOptions={provOptions}
          onAutocompleteChange={(e, o) => {
